-- =====================================================
-- FIX NOTIFICATION TRIGGERS - USE CORRECT PROFILE QUERY
-- Description: Fix triggers to use profiles_with_org view or JOIN
-- Date: 2025-10-18
-- =====================================================
...
-- =====================================================
-- TRIGGER 1: Fix entrada status change notification
-- =====================================================
...
BEGIN
  ...
  IF OLD.estado IS DISTINCT FROM NEW.estado THEN
    ...
    -- Obtener ID del técnico asignado usando profiles_with_org view
    IF NEW.tecnico_asignado IS NOT NULL THEN
      SELECT id INTO v_technician_id
      FROM public.profiles_with_org
...
-- =====================================================
-- TRIGGER 2: Fix new entrada notification
-- =====================================================
...
-- =====================================================
-- TRIGGER 5: Fix technician change notification
-- =====================================================
...
BEGIN
  ...
  IF OLD.tecnico_asignado IS DISTINCT FROM NEW.tecnico_asignado THEN
    ...
    -- Obtener ID del técnico anterior usando profiles_with_org view
    ...
    -- Obtener ID del nuevo técnico usando profiles_with_org view
    IF NEW.tecnico_asignado IS NOT NULL THEN
...
-- =====================================================
-- TRIGGER 4: Fix bitacora comment notification
-- =====================================================
...
DO $$
BEGIN
  RAISE NOTICE '✅ SUCCESS: Notification triggers fixed to use profiles_with_org view';
  RAISE NOTICE '';
  RAISE NOTICE 'Changes:';
  RAISE NOTICE '  - Now using profiles_with_org view instead of profiles table';
  RAISE NOTICE '  - This view includes org_id via JOIN with org_members';
  RAISE NOTICE '  - All technician lookups by email now work correctly';
  RAISE NOTICE '';
END $$;
